...
#####################################################################################################
### CONFIG VARS #####################################################################################
declare LLTEST_CMD="/app/ucc server DM-Hood.unr?Game=Botpack.DeathMatchPlus -nohomedir -lanplay";
declare LLTEST_NAME="gamesvr-ut99-freeplay-$(date '+%H%M%S')";
#####################################################################################################
#####################################################################################################
...
should_have 'Server Package: Unlimitedammo' 'unlimited ammo mutator defined';
should_have 'Bringing Level DM-Hood.MyLevel up for play' 'Custom level loaded';
#####################################################################################################
#####################################################################################################
